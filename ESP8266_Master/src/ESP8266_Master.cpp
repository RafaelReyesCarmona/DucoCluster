...
// Display
#define         OLED_PIN_SDA                                          D1                                          // The communication pin for SDA (D2 on ESP8266)
#define         OLED_PIN_SCL                                          D2                                          // The communication pin for SCL (D1 on ESP8266)
...
// Configuration
String          softwareName                                        = "DuinoCluster";                             // The name of this software          
...
String          nameRig                                             = "DuinoCluster";                             // Your name for this rig
